functor VaporeonLexFun(structure Tokens: Vaporeon_TOKENS)  = struct
...
fun yyAction2 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm; (Tokens.NUM (Rational.fromDecimal yytext, !pos, !pos))
      end
       ...
       of NONE => yyAction12(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              ...
              then if inp = #"."
                  then yyQ14(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
       ...
       of NONE => yyAction12(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #")"
              ...
              then yyQ17(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp < #"0"
              then yyAction12(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ17(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
